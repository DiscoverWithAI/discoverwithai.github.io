...
*A:* For the actual research of all the information needed for a standard one-week to ten-day trip, considering that two or three of us do it, I would say we spend at most 5 or 6 half-days spread over a week. That's a reasonable amount of time, but I'd definitely prefer to spend less: the less time spent searching, the more time gained for traveling!
#v(10pt)
*Q: _Were you satisfied with what they organized?_*\
*A:* Most of the time, yes, I am satisfied because the main goal is achieved. The secret is that we don’t seek perfection, but efficiency. The group provides me with the basic information: 'This train leaves at this time' or 'This hostel is central and costs so much.' I take those details and fit them into my framework. Of course, there have been minor setbacks. I remember in Spain, someone found a very cheap local bus, but it made us lose three hours due to an unnecessary detour.
#v(10pt)
*Q: _Was it easy to manage and keep track of all the travel tickets, passes and documents?_*\
*A:* Much less difficult than one might think. For all our group trips, we solved it right away with a shared cloud folder (like Google Drive, to be clear) where we save everything in PDF format. Every group member is given access. The rule is that each person is ultimately responsible for their own plane ticket and visa (if needed), but all passes, museum entries bought as a group, and hostel reservations go into that shared folder.
